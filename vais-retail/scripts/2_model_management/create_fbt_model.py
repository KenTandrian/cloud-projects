...
MODEL_DISPLAY_NAME = "frequently_bought_together_1"
MODEL_TYPE = "frequently-bought-together"
OPTIMIZATION_OBJECTIVE = "revenue-per-order"
# -------------------

def create_retail_model():
    """Creates the 'Frequently Bought Together' recommendation model."""
    model_config = Model(
        name=f"{default_catalog}/models/{MODEL_DISPLAY_NAME}",
        display_name="Frequently Bought Together 1",
        type_=MODEL_TYPE,
