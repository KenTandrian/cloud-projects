...
startAudioButton.addEventListener("click", () => {
  if (startAudioButton.textContent === "Start Audio") {
    startAudioButton.textContent = "Stop Audio";
    startAudioButton.classList.remove("bg-green-500");
    startAudioButton.classList.add("bg-red-500");
    startAudio();
    is_audio = true;
    ...
    startAudioButton.classList.remove("bg-red-500");
    startAudioButton.classList.add("bg-green-500");
    stopAudio();
    is_audio = false;
    eventSource.close(); // close current connection
    connectSSE(); // reconnect with the audio mode
